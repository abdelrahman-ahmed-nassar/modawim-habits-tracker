...
export {
  ...
  getCompletionsByUserIdInDateRange,
  createCompletion,
...
export const dataService = {
  ...
  getHabitsByUserId: habitService.getHabitsByUserId,
  getActiveHabitsByUserId: habitService.getActiveHabitsByUserId,
  ...
  getCompletionsByUserId: habitService.getCompletionsByUserId,
  getCompletionsByHabitId: habitService.getCompletionsByHabitId,
  getCompletionsByDate: habitService.getCompletionsByDate,
  getCompletionsByUserIdAndDate: habitService.getCompletionsByUserIdAndDate,
  getCompletionsByUserIdInDateRange: habitService.getCompletionsByUserIdInDateRange,
  ...
  getNotesByUserId: noteService.getNotesByUserId,
  getNoteByDate: noteService.getNoteByDate,
  getNoteByUserIdAndDate: noteService.getNoteByUserIdAndDate,
